# Contributing to Chronicle-PDF

Thank you for your interest in contributing to Chronicle-PDF! There are many ways to contribute other than writing code. For example, reporting bugs, creating suggestions, and adding or modifying translations.
...
If you would like to add or modify a translation, please see [How to add new languages to Chronicle-PDF](devGuide/HowToAddNewLanguage.md). Also, please create a Pull Request so others can use it!

## Docs

Documentation for Chronicle-PDF is handled in a separate repository. Please see [Docs repository](https://github.com/aaronkr-navi/aaronkr-navi.github.io) or use the "edit this page"-button at the bottom of each page at [https://docs.chronicle-pdf.com/](https://docs.chronicle-pdf.com/).
