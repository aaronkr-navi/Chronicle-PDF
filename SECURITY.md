...
The Chronicle-PDF team takes security vulnerabilities seriously. We appreciate your efforts to responsibly disclose your findings.
...
2. **Direct Email**:
   - Send your report to security@chronicle-pdf.com
...
At this time, we do not offer a bug bounty program. However, we greatly appreciate your efforts in making Chronicle-PDF more secure and will acknowledge your contribution in our release notes (unless you prefer to remain anonymous).

## Supported Versions

Only the latest version of Chronicle-PDF is supported for security updates. We do not backport security fixes to older versions.
...
**Please note:** Before reporting a security issue, ensure you are using the latest version of Chronicle-PDF. Security reports for older versions will not be accepted.

## Security Best Practices

When deploying Chronicle-PDF:
