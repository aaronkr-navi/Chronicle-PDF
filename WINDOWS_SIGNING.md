...
This guide explains how to set up Windows code signing for Chronicle-PDF desktop application builds.
...
Get-AuthenticodeSignature "./src-tauri/target/release/bundle/msi/Chronicle-PDF_*.msi"
```
...
**Windows (PowerShell):**
```powershell
Get-AuthenticodeSignature "Chronicle-PDF-windows-x86_64.exe"
Get-AuthenticodeSignature "Chronicle-PDF-windows-x86_64.msi"
```
