...
class ApplicationPropertiesLogicTest {
    ...
    void tempFileManagement_defaults_and_overrides() {
        ...
        String expectedBase =
                Path.of(java.lang.System.getProperty("java.io.tmpdir"), "Chronicle-PDF").toString();
    ...
    void enterprise_metadata_defaults() {
        ...
        assertEquals("Chronicle-PDF", eMeta.getCreator());
        assertEquals("Chronicle-PDF", eMeta.getProducer());
    }
    ...
    void premium_metadata_defaults() {
        ...
        pMeta.setCreator("");
        pMeta.setProducer("");
        assertEquals("Chronicle-PDF", pMeta.getCreator());
        assertEquals("Chronicle-PDF", pMeta.getProducer());
    }
