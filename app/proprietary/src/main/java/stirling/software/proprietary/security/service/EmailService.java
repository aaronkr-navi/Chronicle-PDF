...
public class EmailService {
    ...
    public void sendInviteEmail(
            ...
            throws MessagingException {
        String subject = "Welcome to Chronicle PDF";
                ...
                <div style="font-family: Arial, sans-serif; background-color: #f8f9fa; padding: 20px;">
                  <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e0e0e0;">
                    ...
                    <div style="text-align: center; padding: 20px; background-color: #222;">
                      <img src="https://raw.githubusercontent.com/aaronkr-navi/Chronicle-PDF/main/docs/Chronicle-transparent.svg" alt="Chronicle PDF" style="max-height: 60px;">
                    </div>
                    <!-- Content -->
                    <div style="padding: 30px; color: #333;">
                      <h2 style="color: #222; margin-top: 0;">Welcome to Chronicle PDF!</h2>
                      <p>Hi there,</p>
                      ...
                      <div style="text-align: center; margin: 30px 0;">
                        <a href="%s" style="display: inline-block; background-color: #007bff; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 5px; font-weight: bold;">Log In to Chronicle PDF</a>
                      </div>
                      ...
                      <p style="margin-bottom: 0;">— The Chronicle PDF Team</p>
                    </div>
                    <!-- Footer -->
                    <div style="text-align: center; padding: 15px; font-size: 12px; color: #777; background-color: #f0f0f0;">
                      &copy; 2025 Chronicle PDF. All rights reserved.
                    </div>
                  </div>
                </div>
                </body></html>
    ...
    public void sendInviteLinkEmail(String to, String inviteUrl, String expiresAt)
            throws MessagingException {
        String subject = "You've been invited to Chronicle PDF";
                ...
                <div style="font-family: Arial, sans-serif; background-color: #f8f9fa; padding: 20px;">
                  <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e0e0e0;">
                    ...
                    <div style="padding: 30px; color: #333;">
                      <h2 style="color: #222; margin-top: 0;">Welcome to Chronicle PDF!</h2>
                      <p>Hi there,</p>
                      <p>You have been invited to join the Chronicle PDF workspace. Click the button below to set up your account:</p>
                      <!-- CTA Button -->
                      <div style="text-align: center; margin: 30px 0;">
    ...
    public void sendPasswordChangedNotification(
            ...
            throws MessagingException {
        String subject = "Your Chronicle PDF password has been updated";
                ...
                <div style=\"font-family: Arial, sans-serif; background-color: #f8f9fa; padding: 20px;\">
                  <div style=\"max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; border: 1px solid #e0e0e0;\">
                    ...
                    <div style=\"padding: 30px; color: #333;\">
                      ...
                      <p>Hello %s,</p>
                      <p>An administrator has updated the password for your Chronicle PDF account.</p>
                      %s
                      <p>If you did not expect this change, please contact your administrator immediately.</p>
                      <div style=\"text-align: center; margin: 30px 0;\">
                        <a href=\"%s\" style=\"display: inline-block; background-color: #007bff; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 5px; font-weight: bold;\">Go to Chronicle PDF</a>
                      </div>
                      <p style=\"font-size: 14px; color: #666;\">Or copy and paste this link in your browser:</p>
                      <div style=\"background-color: #f8f9fa; padding: 12px; margin: 15px 0; border-radius: 4px; word-break: break-all; font-size: 13px; color: #555;\">
                        %s
