            ...
            try {
                ...
                try {
                    ClassPathResource logoRes =
                            new ClassPathResource("static/images/Chronicle-logo-white.png");
                    ...
                    log.debug(
                            "Could not load Chronicle-PDF logo for summary page: {}",
                            e.getMessage());
                    cs.setNonStrokingColor(Color.WHITE);
                    cs.beginText();
                    cs.setFont(fontBold, 13);
                    cs.newLineAtOffset(logoX, PAGE_H - 28);
                    cs.showText("Chronicle PDF");
                    cs.endText();
                }
                ...
                String footerText = "Generated by Chronicle-PDF";
