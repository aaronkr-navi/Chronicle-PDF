...
This guide outlines the common error handling patterns used within Chronicle-PDF and provides tips for internationalising error messages. The examples cover the main languages found in the project: Java, JavaScript, HTML/CSS, and a small amount of Python.
...
Java forms the core of Chronicle-PDF. When adding new features or handling errors:
...
Following these patterns helps keep Chronicle-PDF stable, easier to debug, and friendly to users in all supported languages.
