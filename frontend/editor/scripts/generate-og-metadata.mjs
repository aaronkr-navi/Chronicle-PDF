...
const SITE_NAME = "Chronicle PDF";
const SITE_TITLE = "Chronicle PDF";
...
const SAAS_DEFAULT = {
  ...
  title: "Chronicle PDF - Edit any PDF. Govern every PDF.",
...
const SAAS_ROUTE_OVERRIDES = {
  "/processor": {
    ...
    title: "Chronicle Processor - Govern every PDF your organization touches",
  ...
  "/editor": {
    ...
    title: "Chronicle PDF - The world's most secure PDF editor",
