...
/**
 * Chronicle PDF Sample Document Generator
 *
 ...
 * for users to experiment with Chronicle PDF's features.
 */
...
async function generatePDF() {
  console.log("🚀 Starting Chronicle PDF sample document generation...\n");
  ...
  console.log("\n🎉 Done! Sample PDF is ready for use in Chronicle PDF.\n");
}
