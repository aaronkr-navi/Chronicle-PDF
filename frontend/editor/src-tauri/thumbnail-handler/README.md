...
A lightweight COM DLL that provides PDF page-preview thumbnails in Windows Explorer when Chronicle-PDF is the default PDF application.
...
cargo build --release
# Output: target/release/chronicle_thumbnail_handler.dll
```
