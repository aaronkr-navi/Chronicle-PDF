//! Chronicle PDF Windows Thumbnail Handler
//!
...
const CLSID_CHRONICLE_THUMBNAIL: GUID = GUID::from_u128(0x2d2fbe3a_9a88_4308_a52e_7ef63ca7cf48);
...
unsafe extern "system" fn DllGetClassObject(
    ...
    *ppv = std::ptr::null_mut();
    ...
    if *rclsid != CLSID_CHRONICLE_THUMBNAIL {
