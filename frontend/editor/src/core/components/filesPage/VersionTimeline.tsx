...
function deltaToolFor(
  version: ChronicleFileStub,
  prior: ChronicleFileStub | null,
): ToolOperation | null {
...
export function VersionTimeline({
  ...
  const byVersionNumber = useMemo(() => {
    const map = new Map<number, ChronicleFileStub>();
  ...
  type Row =
    | { kind: "version"; version: ChronicleFileStub }
    | {
        kind: "ellipsis";
        hidden: number;
      };
