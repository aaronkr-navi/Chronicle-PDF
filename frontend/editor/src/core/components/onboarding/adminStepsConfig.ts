...
const ADMIN_STEP_SPECS: AdminStepSpec[] = [
  ...
  },
  {
    ...
    contentDefault:
      "That's the admin tour! You've seen the enterprise features that make Chronicle PDF a powerful, customisable solution for organisations. You can replay it anytime — just open <strong>Settings</strong> and find it here in the <strong>Tours</strong> section under Help.",
    position: "right",
    section: "help",
