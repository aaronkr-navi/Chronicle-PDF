...
export default function AnalyticsChoiceSlide({
  ...
  return {
    ...
    title: i18n.t(
      "analytics.title",
      "Do you want to help make Chronicle PDF better?",
    ),
    body: (
      <div className={styles.bodyCopyInner}>
        <Trans
          i18nKey="analytics.paragraph1"
          defaults="Chronicle PDF has opt-in analytics to help us improve the product. We do not track any personal information or file contents."
          components={{ strong: <strong /> }}
        />
        <br />
        <Trans
          i18nKey="analytics.paragraph2"
          defaults="Please consider enabling analytics to help Chronicle PDF grow and to allow us to understand our users better."
          components={{ strong: <strong /> }}
        />
        <br />
        <div style={{ textAlign: "right", marginTop: 0 }}>
          <Button
            ...
            onClick={() =>
              window.open(
                "https://docs.chronicle-pdf.com/analytics-telemetry/",
                "_blank",
              )
            }
