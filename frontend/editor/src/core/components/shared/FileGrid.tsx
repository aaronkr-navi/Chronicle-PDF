...
interface FileGridProps {
  files: Array<{ file: File; record?: ChronicleFileStub }>;
  onRemove?: (index: number) => void;
  onDoubleClick?: (item: { file: File; record?: ChronicleFileStub }) => void;
  onView?: (item: { file: File; record?: ChronicleFileStub }) => void;
  onEdit?: (item: { file: File; record?: ChronicleFileStub }) => void;
      ...
      >
        {displayFiles
          .filter((item) => {
            if (!item.record?.id) {
              console.error(
                "FileGrid: File missing ChronicleFileStub with proper ID:",
                item.file.name,
              );
              return false;
            }
