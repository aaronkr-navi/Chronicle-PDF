  ...
  const handleRevokeLink = useCallback(
    async (token: string) => {
      ...
      try {
        ...
        actions.updateChronicleFileStub(file.id, {
                    ...
                    <Stack gap="xs">
                      <Text size="sm">
                        {t(
                          ...
                          "This looks like an email address. If this person is not already a Chronicle PDF user, they will not be able to access the file.",
                        )}
                      </Text>
                      <Group justify="flex-end" gap="sm">
                        <Button
