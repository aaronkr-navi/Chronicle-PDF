...
export const SERVER_LICENSE_REQUEST_EVENT = "chronicle:server-license-requested";
export const UPGRADE_BANNER_TEST_EVENT = "chronicle:upgrade-banner-test";
export const UPGRADE_BANNER_ALERT_EVENT = "chronicle:upgrade-banner-alert";
export const START_TOUR_EVENT = "chronicle:start-tour";
export const TOUR_STATE_EVENT = "chronicle:tour-state";
