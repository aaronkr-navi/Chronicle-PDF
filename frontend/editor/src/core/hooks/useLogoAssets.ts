...
export function useLogoAssets() {
  ...
  return useMemo(() => {
    ...
    return {
      ...
      wordmark: {
        black: `${folderPath}/ChroniclePDFLogoBlackText.svg`,
        grey: `${folderPath}/ChroniclePDFLogoGreyText.svg`,
        white: `${folderPath}/ChroniclePDFLogoWhiteText.svg`,
      },
      iconDark: `${folderPath}/ChroniclePDFLogoNoTextDark.svg`,
      iconLight: `${folderPath}/ChroniclePDFLogoNoTextLight.svg`,
