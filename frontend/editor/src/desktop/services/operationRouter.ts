          ...
          if (!supportedLocally) {
            ...
            throw new Error(
              i18n.t(
                ...
                "This tool requires an account. Sign in to Chronicle Cloud or connect to a self-hosted server to use it.",
              ),
            );
          }
        }
      ...
      if (status === "offline") {
        ...
        throw new Error(
          i18n.t(
            ...
            'Your Chronicle PDF server is offline and "{{endpoint}}" is not available on the local backend.',
