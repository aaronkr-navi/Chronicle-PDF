...
/**
 * Configures the shared Supabase client against the Chronicle Supabase project so
 ...
 * — the one Chronicle Supabase project every flavor talks to (same vars the editor
...
export const PENDING_LINK_KEY = "Chronicle-account-link-pending";
