        ...
        <div>
          ...
          <h2 className="portal-link__title">
            {t(
              ...
              "Link this org to its Chronicle account",
            )}
          </h2>
        </div>
      ...
      {!link.loginConfigured && (
        ...
        >
          ...
          {t(
            ...
            "to enable account linking against the hosted Chronicle account. In dev you can simulate sign-in from the link dialog.",
          )}
        </Banner>
      )}
