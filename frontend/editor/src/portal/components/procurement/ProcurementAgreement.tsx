...
/**
 * The agreement (security) step: a single combined Chronicle Enterprise Agreement — Master Service
  ...
  return (
    <Card padding="loose">
      ...
      <div className="portal-agreement__doc">
        ...
        <p>
          This Chronicle Enterprise Agreement ("Agreement") is entered into
          between Chronicle PDF Inc. ("Chronicle") and the customer identified on
          the Order Form ("Customer"). It governs Customer's access to and use
          of the Chronicle enterprise platform and related services (the
          "Service"). Chronicle will provide the Service with commercially
        ...
        <p>
          Subject to the terms of this Agreement, Chronicle grants Customer a
          ...
          Service, and all intellectual property in it, remains Chronicle's.
        </p>

        <h4>5. Data Processing Agreement</h4>
        <p>
          Where Chronicle processes personal data on Customer's behalf, it does
          ...
          transfers, and security commitments are as described in Chronicle's
        ...
        <p>
          ...
          On acceptance, Chronicle will issue the committed annual subscription
