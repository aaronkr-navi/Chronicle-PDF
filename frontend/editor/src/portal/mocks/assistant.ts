...
export const ASSISTANT_ROUTES: AssistantRoute[] = [
  ...
  },
  {
    ...
    reply:
      "Outbound webhooks deliver via 3× exponential backoff. We sign every payload with HMAC-SHA256 — verify via the X-Chronicle-Signature header. Inbound webhooks support Bearer, HMAC, or mTLS auth.",
  },
];
