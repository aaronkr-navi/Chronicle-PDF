          ...
          <div>
            ...
            <p className="portal-usage__subtitle">
              {t(
                ...
                "Consumption, invoices, and plan management for every PDF Chronicle has billed, in one console.",
              )}
            </p>
          </div>
        ...
        {sessionExpired && (
          ...
          >
            {t(
              ...
              "Your Chronicle account session has expired. Sign in again to view billing — your instance stays linked.",
            )}
          </Banner>
        )}
