    ...
    > => {
      ...
      const result: FeaturesSettingsData & {
        ...
        serverCertificate: systemData.serverCertificate || {
          enabled: true,
          organizationName: "Chronicle PDF Inc",
          validity: 365,
          ...
          <Stack gap="md">
            ...
            <Text size="xs" c="dimmed">
              {t(
                ...
                'Configure server-side certificate generation for "Sign with Chronicle PDF" functionality',
              )}
            </Text>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <Text size="xs" c="dimmed" mt={4}>
                  {t(
                    ...
                    'Enable server-side certificate for "Sign with Chronicle PDF" option',
                  )}
                </Text>
              </div>
              <Group gap="xs">
