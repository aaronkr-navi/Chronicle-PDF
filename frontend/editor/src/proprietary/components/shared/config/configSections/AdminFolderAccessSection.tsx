          ...
          <Alert variant="light" color="blue">
            <Text size="xs">
              {t(
                ...
                "Leave this empty to disable folder sources and outputs entirely. Chronicle's own configuration directory is always off-limits, and folder access is always disabled in hosted (SaaS) mode.",
              )}
            </Text>
          </Alert>
                ...
                <div>
                  ...
                  <Text size="xs" c="dimmed">
                    {t(
                      ...
                      "These Chronicle-managed directories are always permitted and can't be changed here.",
                    )}
                  </Text>
                </div>
                <Stack gap="xs">
