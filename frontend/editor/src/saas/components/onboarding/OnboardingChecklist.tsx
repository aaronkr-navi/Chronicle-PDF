    ...
    () => [
      {
        ...
        titleFallback: "Download Chronicle for Desktop",
        descriptionKey: "onboarding.checklist.downloadDesktop.description",
        descriptionFallback: "Run Chronicle natively on your machine",
      ...
      },
      {
        ...
        descriptionFallback: "See how Chronicle works in a quick walkthrough",
      ...
      },
      {
        ...
        descriptionFallback: "Help improve Chronicle",
        ...
        >
          <span className={styles.titleGroup}>
            ...
            <span className={styles.title}>
              {t("onboarding.checklist.title", "Set up Chronicle PDF")}
            </span>
          </span>
