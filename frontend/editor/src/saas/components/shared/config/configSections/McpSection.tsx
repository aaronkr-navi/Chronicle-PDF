        ...
        <div>
          ...
          <Text size="sm" c="dimmed" mt={6}>
            {t(
              ...
              "Model Context Protocol (MCP) lets AI assistants like Claude use your Chronicle PDF tools directly. Connect a client once and your assistant can convert, edit, secure and process documents on your behalf.",
            )}
          </Text>
        </div>
              ...
              >
                <Text size="sm" c="dimmed" style={{ flex: 1 }}>
                  {t(
                    ...
                    "Guest users can't connect MCP clients. Create an account to use the MCP server and let your AI assistant run Chronicle PDF tools on your behalf.",
                  )}
                </Text>
                <Button
                  size="sm"
              ...
              <Stack gap="xs">
                ...
                <Text size="xs" c="dimmed">
                  {t(
                    ...
                    "Pick your client, paste the snippet into the file shown, then restart it. You'll sign in with your Chronicle account on first use - no keys to copy.",
                  )}
                </Text>
                <Tabs
            ...
            >
              ...
              >
                <Text size="sm">
                  {t(
                    "config.mcp.tip",
                    "Every action your assistant runs is performed as your account and counts towards your usage, just like using the Chronicle PDF API and Automation.",
                  )}
                </Text>
                <Button
                  size="sm"
