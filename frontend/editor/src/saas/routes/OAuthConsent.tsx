...
export default function OAuthConsent() {
  ...
  useDocumentMeta({
    title: `${t("oauthConsent.title", "Authorize access")} - Chronicle PDF`,
  });
      ...
      <AuthLayout>
        ...
        <Text ta="center" c="dimmed" mb="lg">
          {t(
            ...
            "Sign in to your Chronicle PDF account to continue connecting the app.",
          )}
        </Text>
        <Button
          variant="secondary"
    ...
    <AuthLayout>
      ...
      <Text ta="center" c="dimmed" mb="lg">
        {t("oauthConsent.requesting", {
          app: appName,
          defaultValue: `${appName} wants to access your Chronicle PDF account`,
        })}
      </Text>
      ...
      {/* Be explicit about what connecting actually grants. The OAuth scopes
          ...
          token lets the app drive the MCP endpoint - i.e. run any Chronicle PDF
        ...
        <List size="sm" spacing={4} c="dimmed">
          <List.Item>
            {t("oauthConsent.access.tools", {
              app: appName,
              defaultValue: `Use your Chronicle PDF tools on your behalf - convert, edit, sign, secure and process your documents`,
            })}
          </List.Item>
          <List.Item>
