...
This directory contains Python scripts for managing frontend translations in Chronicle PDF. These tools help analyze, merge, validate, and manage translations against the en-US golden truth file.

## Current Format: TOML

**Chronicle PDF uses TOML format for translations** in `frontend/editor/public/locales/{lang}/translation.toml`.
...
- Uses GPT-5.6 with specialized prompts for Chronicle PDF
...
- Specialized system prompts for Chronicle PDF translations
