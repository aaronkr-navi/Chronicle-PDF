...
class BatchTranslator:
    ...
    def get_translation_prompt(self, language_name: str, language_code: str) -> str:
        ...
        return f"""You are a professional translator for Chronicle PDF, an open-source PDF manipulation tool.

Translate the following JSON from English to {language_name} ({language_code}) for the Chronicle PDF user interface.
...
3. DO NOT TRANSLATE TECHNICAL TERMS:
   ...
   - "Chronicle PDF" - always keep as-is
