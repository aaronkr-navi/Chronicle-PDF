...
@given("the pdf has a Chronicle-PDF QR code split marker on page {page_num:d}")
def step_pdf_has_qr_split_marker(context, page_num):
    """Replace page page_num (1-indexed) with a page containing a Chronicle-PDF QR code."""
    try:
    ...
    qr.add_data("https://github.com/aaronkr-navi/Chronicle-PDF")
    qr.make(fit=True)
